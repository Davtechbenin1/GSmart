...
class Data_handler:
	...
	def drop_all_tables(self, dbname, user, password, host="localhost", port=8000):
		try:
...
# Gestion des entrées et sorties
	...
	def Save_data(self, base_name, table, data, data_ident = None):
		"""
